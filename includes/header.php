...
if (!isset($_SESSION['usuario'])) {
    ...
    <div class='alert alert-warning' role='alert'>
        Para poder comprar, primero iniciar sesión.
    </div>";
}
    ...
    <header id="header">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                <!-- Logo -->
                <a class="navbar-brand" href="home.php"><i class="fa fa-shopping-bag" style="font-size: 35px;"></i> <b style="color: white;"> Sublinter Online </b></a>
